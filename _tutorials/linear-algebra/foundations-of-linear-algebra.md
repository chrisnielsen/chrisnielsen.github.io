...
3. The determinant behaves like a linear function on the rows of the matrix $$\left| {\begin{array}{*{20}{c}}{a + a'}&{b + b'}\\c&d\end{array}} \right| = \left| {\begin{array}{*{20}{c}}a&b\\c&d\end{array}} \right| + \left| {\begin{array}{*{20}{c}}{a'}&{b'}\\c&d\end{array}} \right|$$
4. If we multiply one row of a matrix by $$t$$, then the determinant is multiplied by $$t$$ such that: $$\left| {\begin{array}{*{20}{c}}{ta}&{tb}\\c&d\end{array}} \right| = t\left| {\begin{array}{*{20}{c}}a&b\\c&d\end{array}} \right|$$ 
...
$$\left| {\begin{array}{*{20}{c}}a&b\\c&d\end{array}} \right| = \left| {\begin{array}{*{20}{c}}0&b\\c&d\end{array}} \right| + \left| {\begin{array}{*{20}{c}}a&0\\c&d\end{array}} \right| = \left| {\begin{array}{*{20}{c}}a&0\\0&d\end{array}} \right| + \left| {\begin{array}{*{20}{c}}a&0\\c&0\end{array}} \right| + \left| {\begin{array}{*{20}{c}}0&b\\0&d\end{array}} \right| + \left| {\begin{array}{*{20}{c}}0&b\\c&0\end{array}} \right|$$
...
$$\left| {\begin{array}{*{20}{c}}a&b\\c&d\end{array}} \right| = \left| {\begin{array}{*{20}{c}}a&0\\0&d\end{array}} \right| + \left| {\begin{array}{*{20}{c}}0&b\\c&0\end{array}} \right|$$
From property 4 and property 1 we see that $$\left| {\begin{array}{*{20}{c}}a&0\\0&d\end{array}} \right| = ad\left| {\begin{array}{*{20}{c}}1&0\\0&1\end{array}} \right| = ad$$ and from properties 1, 2, and 4 we see that $$\left| {\begin{array}{*{20}{c}}0&b\\c&0\end{array}} \right| =  - \left| {\begin{array}{*{20}{c}}c&0\\0&b\end{array}} \right| =  - cb\left| {\begin{array}{*{20}{c}}1&0\\0&1\end{array}} \right| =  - cb$$. Finally, we can combine these together to show that $$\left| {\begin{array}{*{20}{c}}a&b\\c&d\end{array}} \right| = ad - bc$$.
...
An important question to understand is: what is the bound of $$\int\limits_{ - \infty }^\infty  {{e^{ - i2\pi \omega t}}f\left( t \right)dt} $$? We can safely assume that every real-life signal will have finite energy which means that$$\int\limits_{ - \infty }^\infty  {\left| {f\left( t \right)} \right|dt}  = E$$. Now using the fact that $${e^{ - i2\pi \omega t}}$$ is periodic with amplitude 1, we see that $$\int\limits_{ - \infty }^\infty  {\left| {{e^{ - i2\pi \omega t}}f\left( t \right)} \right|dt}  \le \int\limits_{ - \infty }^\infty  {\left| {f\left( t \right)} \right|dt}  = E$$. 
